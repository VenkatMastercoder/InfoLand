...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup" method="post">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            ...
            <a href="./FireBase/auth.php"><button class="box-button">Join Free Now</button></a>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-6">
          <h5 class="footer-Heading mb-2">Pages</h5>
            <ol class="footer-subheading list-unstyled">
              <li class="pb-1"><a class="Footer-Li-tag" href="index.php">Home</a></li>
        ...
        <div class="col-lg-2 col-md-6">
          <h5 class="footer-Heading mb-2">Legal</h5>
            <ul class="footer-subheading list-unstyled">
              <li class="pb-1"><a class="Footer-Li-tag" href="">Privacy Policy</a></li>
              <li class="pb-1"><a class="Footer-Li-tag" href="">Terms and Service</a></li>
            </ul>  
        </div>
